...
def pub_test():
          ...
          #实例化一个action的类，命名为client，与上述client对应，话题为/robot1/vel_joint_traj_controller/follow_joint_trajectory，消息类型为FollowJointTrajectoryAction
          client = actionlib.SimpleActionClient('robot1/vel_joint_traj_controller/follow_joint_trajectory', FollowJointTrajectoryAction)
